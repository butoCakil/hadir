...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h2 class="text-center">Upload File Excel datasiswa</h2>
            <form method="post" enctype="multipart/form-data" action="uploadexcel.php">
                <div class="mb-3">
                    <a class="btn btn-warning btn-sm" href="datasiswa.xlsx">Unduh Template Data Siswa</a>
                </div>
                <div class="mb-3">
            ...
            <hr>
            <div class="mb-3">
                <a href="penempatan.php" class="btn btn-secondary btn-sm">Ke Upload Penempatan</a>
            </div>
            <div class="mb-3">
            ...
            <div>
                <a href="sinkron_pembimbing.php" class="btn btn-danger btn-sm mb-2">Sinkron Pembimbing</a>
            </div>
            <div>
                <a href="sinkron_siswa.php" class="btn btn-danger btn-sm">Sinkron Siswa</a>
            </div>
        </div>
    </section>
